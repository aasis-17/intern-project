...
const ServiceProfile = () => {
  ...
  const {data : serviceDetails , isLoading, isError} = useQuery({
      ...
      queryFn : () => serviceOwnerService.getServiceProfile(id)
  })
  ...
  return (
     ...
     <div>
        ...
        <img
          src={serviceCoverImage} // Replace with your hero image
          alt="Hotel Banner"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-6xl font-bold text-white mb-4">{serviceName}</h1>
      ...
      <ReviewStar avgReview={avgReview} />
